...
public class CustomRendererFeature : ScriptableRendererFeature {
    ...
    public class CustomRenderPass : ScriptableRenderPass {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData) {
            ...
            if (settings.rtCustomColorName != ""){
                RenderingUtils.ReAllocateIfNeeded(ref rtCustomColor, colorDesc, name: settings.rtCustomColorName);
            }else{
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            using (new ProfilingScope(cmd, _profilingSampler)) {
                ...
                // always try to call ExecuteCommandBuffer at least once before using ScriptableRenderContext 
                // functions (e.g. DrawRenderers) and again outside the using ProfilingScope.
                ...
                if (settings.rtCustomColorName != "") 
                    cmd.SetGlobalTexture(settings.rtCustomColorName, rtCustomColor);
    ...
    public class Settings {
        ...
        public string rtCustomColorName = "";
    ...
    public override void Create() {
        settings.overrideMaterial.SetColor("_TintColor", settings.tintColor);
